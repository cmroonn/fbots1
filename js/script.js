...
document.addEventListener("DOMContentLoaded", function () {
  ...
  try {
    function customSelect(elSelectNative, elSelectCustom) {
    ...
    document.querySelectorAll(".select").forEach(function(el) {
      const native = el.querySelector('.js-selectNative');
      const custom = el.querySelector('.js-selectCustom')
      customSelect(native, custom);
    })
  } catch(e) {
    console.log(e);
  }
  ...
  try {
    const removeBtns = document.querySelectorAll('.pc__accounts__body__row__remove');
    const removePopup = document.getElementById("remove-account");
    const overlay = document.querySelector('.overlay');
  ...
  try {
    const removePopup = document.getElementById("add-session");
    const overlay = document.querySelector('.overlay');
    const addSessionBtn = document.querySelectorAll('.add-session');

    addSessionBtn.forEach(function(elem) {
      elem.addEventListener("click", function(e) {
        removePopup.classList.add('active');
        overlay.classList.add("active");
      });
  ...
  try {
    ...
    btn.addEventListener("click", function(e) {
      ...
      normalBtn.classList.remove('edit-mode');
    });
